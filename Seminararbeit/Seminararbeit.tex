...
% TODO: QUELLE: https://www.calculator.net/big-number-calculator.html
...
Die Wahl einer Game-Engine als Entwicklungsumgebung hat auch einen großen Einfluss auf die Laufzeit, durch viele für dieses Programm unnötige Hintergrundprozesse. Auch das einzelne Darstellen von Flügen auf der Map-Textur verbraucht viele Ressourcen.
...
Dies sorgt schnell für einen sehr umfangreichen Quaternärbaum und damit auch für viele Quadcopter Flüge.
\\[0.4cm]
...
Alle enthaltenen Abbildungen wurden entweder selbst mit unten aufgelisteten Tools erstellt oder von unten genannten Programmen/Quellen gescreenshottet.
\begin{itemize}
