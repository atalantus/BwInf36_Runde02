...
namespace Aufgabe1_DieKunstDerFuge
{
    ...
    public class WallBuilder
    {
        ...
        /// <summary>
        /// Stopwatch for measuring the algorithm execution time.
        /// </summary>
        ...
        /// </summary>
        /// <param name="n">The <see cref="BricksPerRow"/>.</param>
        public void BuildWall(int n)
        {
            ...
            // Start Algorithm by filling the first gap
        ...
        /// <summary>
        /// Tries to fill a gap inside the wall.
        /// </summary>
        /// <param name="nextGap">The Gap position to fill starting at 0.</param>
        /// <param name="curWall">The Wall to fill the gap in.</param>
        /// <param name="freeGaps">The amount of gap positions that can still be left free inside the wall.</param>
        /// <returns></returns>
        public Wall FillNextGap(int nextGap, Wall curWall, int freeGaps)
        {
            ...
            var possibleRows = wall.Rows
                .Where(r => r.NextPossibleRowSums.Any(nrs => ContainsPossibleRowSum(r, nrs, nextGapPos))).ToArray();
            ...
            for (var i = 0; i < possibleRows.Length; i++)
            {
                ...
                // remove wrong placed brick and try next branch
        ...
        /// <summary>
        /// Checks whether a <see cref="NextPossibleRowSum"/> fits the next open gap.
        /// </summary>
